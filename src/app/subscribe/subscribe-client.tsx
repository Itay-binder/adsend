...
const RENEWAL_URL = 'https://secure.cardcom.solutions/EA/EA5/ymBL8bB4kiRem64YCUUwQ/PaymentSP'
...
export function SubscribeClient({ hasUsedTrial }: { hasUsedTrial: boolean }) {
  ...
  async function handleSubscribe() {
    ...
    // Returning customer who already used their trial → go straight to the ₪99 page
    if (hasUsedTrial) {
      window.location.href = RENEWAL_URL
      return
    }

    // First-time customer → ₪0 token capture, then 7-day trial
    try {
